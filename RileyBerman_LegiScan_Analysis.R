...
people <- people |> filter(!str_detect(party, "I")) 
...
source("RileyBerman_PartyProportions.R")
...
#Finish if graph bugs ever fixes
...
#             republican_percentage = first(republican_percentage),
#             democrat_percentage = first(democrat_percentage),
#             .by = c(session_year, party_partisanship)) |>
#   mutate(weighted_bipartisan2 = ifelse(party_partisanship == "R", 
#                                        total_bipartisan2/republican_percentage, 
#                                        total_bipartisan2/democrat_percentage)) |>
#   ggplot(aes(x = session_year)) + 
