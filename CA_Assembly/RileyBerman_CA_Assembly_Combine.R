...
#             Outputted results as a .csv file in a created folder called "CA_Assembly_Combined". 
...
dir.create("CA_Assembly_Combined", showWarnings = FALSE)

#Exporting the final data set as .csv
write_csv(CA_Assembly_Final, paste0("CA_Assembly_Combined/CA_Assembly_Final.csv"))
